...
CREATE TABLE [dbo].[VendorInformation](
	[Id] [int] IDENTITY(1,1) NOT NULL,
	[UserId] [int] NOT NULL, --- can be zero in case of non user vendor. For now we are providing zero.
	[SocietyId] [int] NOT NULL,
	[Name] [varchar](256) NOT NULL,
	[GenderId] int NOT NULL,
	[BadgeNumber] [int] NULL,
...
UNION ALL SELECT 'Buy', 1
UNION ALL SELECT 'Sell', 1
...
CREATE TABLE [dbo].[NoticeBoard](
	...
	[SocietyId] [int] NOT NULL,
	[NoticeTypeId] [int] not null, --- Admin, General, sell, buy 
...
CREATE TABLE [dbo].[Complaint](
	...
	[Subject] [varchar](255) NOT NULL,
	[CreatedDate] [datetime] NOT NULL,
	[AssignedToVendtorTypeId] [int] NOT NULL,
	[Status] [int] NULL
) ON [PRIMARY]
...
GO
ALTER TABLE [dbo].[NoticeBoard]  WITH CHECK ADD  CONSTRAINT [FK_NoticeBoard_CreatedById] FOREIGN KEY([CreatedById])
REFERENCES [dbo].[User] ([Id])
GO
ALTER TABLE [dbo].[NoticeBoard] CHECK CONSTRAINT [FK_NoticeBoard_CreatedById]
GO

ALTER TABLE [dbo].[NoticeBoard]  WITH CHECK ADD  CONSTRAINT [FK_NoticeBoard_UpdatedById] FOREIGN KEY([UpdatedById])
REFERENCES [dbo].[User] ([Id])
GO
ALTER TABLE [dbo].[NoticeBoard] CHECK CONSTRAINT [FK_NoticeBoard_UpdatedById]
